window.addEventListener('DOMContentLoaded', () => {
    ...
    let botonCodigo = document.getElementById('boton-veri');
    ...
    botonCodigo.addEventListener('click', function(event) {
        ...
        fetch('./php/register_dosPasos.php', { // Cambiar la URL a tu archivo PHP correcto
            method: 'POST',
            headers: {
        ...
        .then(result => {
            if (result.status === 'success') {
                ...
                <div class="alert alert-secondary" style="text-align: center; margin-top:-12px;">
                    Código de verificación de dos pasos correcto. 
                    <br> 
